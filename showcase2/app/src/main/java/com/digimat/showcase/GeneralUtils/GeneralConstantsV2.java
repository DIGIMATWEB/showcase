...
public class GeneralConstantsV2 { public static final String SUCCESS = "SUCCESS";
    ...
    public static final String MENU_DATA_SAVED="JSON_MENU_DATA_SAVED";
    public static final String MENU_DATA_SAVEDR1="JSON_MENU_DATA_SAVED2";
    public static final String MENU_DATA_SAVEDR2="JSON_MENU_DATA_SAVED3";
