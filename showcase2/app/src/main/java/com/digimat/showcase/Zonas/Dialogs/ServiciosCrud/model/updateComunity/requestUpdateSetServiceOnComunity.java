...
public class requestUpdateSetServiceOnComunity {
    ...
    public requestUpdateSetServiceOnComunity(Integer idComunity, String nameComunity, Integer idServicioPublico, String nameServicio) {
        super();
